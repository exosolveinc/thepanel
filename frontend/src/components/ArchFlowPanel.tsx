...
import { renderSafeMermaid } from '../utils/mermaid'
import clsx from 'clsx'

/* ── Mermaid renderer (sanitized SVG) ─────────────────────────────── */
// Note: configureMermaid() is called at module load by DeepDivePanel; the
// theme variables there apply to all Mermaid renders in the app.
